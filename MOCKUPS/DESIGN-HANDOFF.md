# 0683e52b-1f36-4da6-911b-dc6ed427baf3 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `emails/index.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `emails/index.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `emails/index.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `auth/verify.html`
- `dashboard.html`
- `emails/account-confirmation.html`
- `emails/index.html`
...
- `03-word-editor.md`
- `04-review.md`
- `assets/ladu-inside-bubble-outline.svg`
- `assets/ladu-title-with-icon.svg`
- `drawing-2026-09-06T14-47-08-353Z.png`
- `image.png`
- `Ladu_bubble_filled.svg`
- `Ladu_inside_bubble_outline.svg`
- `Ladu_title_with_icon.svg`

## Coding checklist for AI tools
1. Inspect `emails/index.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
