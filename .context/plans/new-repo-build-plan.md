...
| 3.9 — Dark mode + small fixes | 🚧 in progress — plan: [`phase-3-9-dark-mode.md`](./phase-3-9-dark-mode.md); Slices 0–3 done 2026-09-25 (dark palette; switch on the auth screens and in the header; backend `users.theme`; login carry-over) |
| 4–8 | not started |
