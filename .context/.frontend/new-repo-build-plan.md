...
| 2 — Noun create/view (form engine v1) | 🚧 **in progress** — plan: [`plans/phase-2-noun-crud.md`](./plans/phase-2-noun-crud.md). Slice 1 (backend `_id` strip on word responses + `GET /api/words/:id` ownership check) done; Slices 2–6 pending |
...
### Phase 2 — [`plans/phase-2-noun-crud.md`](./plans/phase-2-noun-crud.md)
