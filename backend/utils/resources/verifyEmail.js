// Account-confirmation email — table-based HTML ported from
// `MOCKUPS/emails/account-confirmation.html`. Localized via `emailStrings`
// (the account's `uiLanguage` at registration time); no expiry sentence —
// verification links never expire (2026-09-22 decision).
"use strict";
...
function getHtmlComponent({ name, url, language }) {
...
<title>${s.titleVerify} — Ladu</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f7f8fa; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">

  <div style="display: none; max-height: 0; overflow: hidden; mso-hide: all;">${s.preheaderVerify}&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
...
function getTextComponent({ name, url, language }) {
  const s = stringsFor(language);
  return [
    s.titleVerify,
    "",
